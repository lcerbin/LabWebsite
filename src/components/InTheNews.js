...
const InTheNews = () => {
    return (
      ...
      <table className="newsContainer">
        ...
        target="_blank" className="newsTitle"> Honoring Ingenuity - Swarthmore College Bulletin</a></h3>
        ...
        target="_blank" className="newsTitle"> Five Women in the Sciences Receive Major Federal Grants</a></h3>
        ...
        target="_blank" className="newsTitle">Listen: Biologist Eva-Maria Collins on the Real-Life Hydra</a></h3>
        ...
        target="_blank" className="newsTitle"> Board of Publications Toxicological Sciences Paper of the Year Award</a></h3>
        ...
        target="_blank" className="newsTitle"> Researchers explain the mechanism of asexual reproduction in flatworms - Phys.org</a></h3>
        ...
        target="_blank" className="newsTitle">Mechanism of asexual reproduction in flatworms - Science Daily</a></h3>
        <br></br>Coverage of the PNAS article Malinowski et al.: "<a className="paperLink" href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5642676/pdf/pnas.201700762.pdf">Mechanics dictate where and how freshwater planarians fission.</a>"
        </p>
        <hr></hr>
        ...
        target="_blank" className="newsTitle">Gaze Into the Disappearing Mouth of the Hydra - HowStuffWorks</a></h3>
        ...
        target="_blank" className="newsTitle">How Hydra Rip Open New Mouths at Every Meal - Smithsonian Magazine</a></h3>
        ...
        target="_blank" className="newsTitle"> Here’s how the hydra rips its own body open to eat a meal - Washington Post</a></h3>
        <br></br>Coverage of the Biophysical Journal publication - Carter and Hyland et al.: "<a className="paperLink" href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4788721/pdf/main.pdf">Dynamics of Mouth Opening in Hydra</a>".
