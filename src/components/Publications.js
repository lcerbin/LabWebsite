...
const Publications = () => {
    return (
      <div>
          ...
          <h3 className = "Head2">Neurotoxicology and Planarian Behavior</h3>
          <table className = "container">
              <tr>
                  ...
                  <td><form action="https://www.biorxiv.org/content/10.1101/2020.01.23.917047v1.full.pdf" target="blank">
              ...
              <tr>
                  ...
                  <td><form action="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6894859/pdf/pone.0226104.pdf" target="blank">
                    <button className="PDF">PDF</button>
                  </form></td>
              </tr>
              <tr>
                  ...
                  <td><form action="https://www.biorxiv.org/content/10.1101/538280v1.full.pdf" target="blank">
                    <button className="PDF">PDF</button>
                  </form></td>
              </tr>
              <tr>
                  ...
                  <td><form action="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6317421/pdf/kfy180.pdf" target="blank">
                    <button className="PDF">PDF</button>
                  </form></td>
              </tr>
              <tr>
                  ...
                  <td><form action="https://europepmc.org/backend/ptpmcrender.fcgi?accid=PMC6657585&blobtype=pdf" target="blank">
                    <button className="PDF">PDF</button>
                  </form></td>
              </tr>
              <tr>
                  ...
                  <td><form action="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6413736/pdf/nihms-1007053.pdf" target="blank">
                    <button className="PDF">PDF</button>
                  </form></td>
              </tr>
              <tr>
                  ...
                  <td><form action="https://europepmc.org/backend/ptpmcrender.fcgi?accid=PMC6485937&blobtype=pdf" target="blank">
                    <button className="PDF">PDF</button>
                  </form></td>
              </tr>
              <tr>
                  ...
                  <td><form action="https://iopscience.iop.org/article/10.1088/1478-3975/13/5/055001" target="blank">
              ...
              <tr>
                  ...
                  <td><form action="https://onlinelibrary.wiley.com/doi/epdf/10.1002/reg2.52" target="blank">
                    <button className="PDF">PDF</button>
                  </form></td>
              </tr>
              <tr>
                  ...
                  <td><form action="https://europepmc.org/backend/ptpmcrender.fcgi?accid=PMC4838007&blobtype=pdf" target="blank">
                    <button className="PDF">PDF</button>
                  </form></td>
              </tr>
              <tr>
                  ...
                  <td><form action="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4154299/pdf/bio-03-07-627.pdf" target="blank">
                    <button className="PDF">PDF</button>
                  </form></td>
              </tr>
          </table>
          ...
          <table className = "container">
              <tr>
                  ...
                  <td><form action="https://www.biorxiv.org/content/10.1101/565465v1.full.pdf" target="blank">
                    <button className="PDF">PDF</button>
                  </form></td>
              </tr>
              <tr>
                  ...
                  <td><form action="https://reader.elsevier.com/reader/sd/pii/S0012160617303500?token=3000D4E068A1BE89560396F5590C8FB5C56B9D5EF5C7E9D8100B609BE7FEB15F5E22EA6A2948782D6725840140F1A7C8" target="blank">
                    <button className="PDF">PDF</button>
                  </form></td>
              </tr>
              <tr>
                  ...
                  <td><form action="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5771031/pdf/main.pdf" target="blank">
                    <button className="PDF">PDF</button>
                  </form></td>
              </tr>
              <tr>
                  ...
                  <td><form action="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5642676/pdf/pnas.201700762.pdf" target="blank">
                    <button className="PDF">PDF</button>
                  </form></td>
              </tr>
              <tr>
                  ...
                  <td><form action="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4788721/pdf/main.pdf" target="blank">
                    <button className="PDF">PDF</button>
                  </form></td>
              </tr>
              <tr>
                  ...
                  <td><form action="https://pubmed.ncbi.nlm.nih.gov/26356147/" target="blank">
                    <button className="PDF">Link</button>
                  </form></td>
              </tr>
              <tr>
                  ...
                  <td><form action="https://europepmc.org/backend/ptpmcrender.fcgi?accid=PMC3808551&blobtype=pdf" target="blank">
                    <button className="PDF">PDF</button>
                  </form></td>
              </tr>
              <tr>
                  ...
                  <td><form action="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2906578/pdf/pnas.1003743107.pdf" target="blank">
                    <button className="PDF">PDF</button>
                  </form></td>
              </tr>
              <tr>
                  ...
                  <td><form action="" target="blank">
                    <button className="PDF">N/A</button>
                  </form></td>
              </tr>
          </table>
          ...
          <table className = "container">
              <tr>
                  ...
                  <td><form action="https://arxiv.org/pdf/1703.04788.pdf" target="blank">
                    <button className="PDF">PDF</button>
                  </form></td>
              </tr>
              <tr>
                  ...
                  <td><form action="https://www.deepdyve.com/lp/springer-journals/to-each-his-own-5Sraz9V0uB" target="blank">
              ...
              <tr>
                  ...
                  <td><form action="https://link.springer.com/article/10.1007/s10955-012-0514-x" target="blank">
                    <button className="Link">PDF</button>
                  </form></td>
              </tr>
              <tr>
                  ...
                  <td><form action="https://link.springer.com/article/10.1007/s10955-011-0157-3" target="blank">
                    <button className="Link">PDF</button>
                  </form></td>
              </tr>
              <tr>
                  ...
                  <td><form action="https://pubmed.ncbi.nlm.nih.gov/21263170/" target="blank">
                    <button className="Link">PDF</button>
                  </form></td>
              </tr>
          </table>
          ...
          <table className = "container">
              <tr>
                  ...
                  <td><form action="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4446096/pdf/pone.0127074.pdf" target="blank">
                    <button className="PDF">PDF</button>
                  </form></td>
              </tr>
              <tr>
                  ...
                  <td><form action="https://www.tandfonline.com/doi/abs/10.2976/1.2834817#aHR0cHM6Ly93d3cudGFuZGZvbmxpbmUuY29tL2RvaS9wZGYvMTAuMjk3Ni8xLjI4MzQ4MTc/bmVlZEFjY2Vzcz10cnVlQEBAMA==" target="blank">
                    <button className="PDF">PDF</button>
                  </form></td>
              </tr>
              <tr>
                  ...
                  <td><form action="https://reader.elsevier.com/reader/sd/pii/S1534580705003059?token=6DFC5D8DE8E74F2C62C16E22DD79DE9ED4239928927344EEF13FCCC01418699BCEB670D639C23F69299A9F7B796E21BB" target="blank">
                    <button className="PDF">PDF</button>
                  </form></td>
              </tr>
          </table>
          ...
          <table className = "container">
              <tr>
                  ...
                  <td><form action="https://www.sciencedirect.com/science/article/abs/pii/S0012160620300889?via%3Dihub" target="blank">
                    <button className="PDF">Link</button>
                  </form></td>
              </tr>
              <tr>
                  ...
                  <td><form action="https://europepmc.org/backend/ptpmcrender.fcgi?accid=PMC6812832&blobtype=pdf" target="blank">
                    <button className="PDF">PDF</button>
                  </form></td>
              </tr>
              <tr>
                  ...
                  <td><form action="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5609432/pdf/jove-125-56115.pdf" target="blank">
                    <button className="PDF">PDF</button>
                  </form></td>
              </tr>
              <tr>
                  ...
                  <td><form action="https://www.nature.com/articles/srep06388.pdf" target="blank">
                    <button className="PDF">PDF</button>
                  </form></td>
              </tr>
              <tr>
                  ...
                  <td><form action="https://jeb.biologists.org/content/jexbio/214/21/3518.full.pdf" target="blank">
                    <button className="PDF">PDF</button>
                  </form></td>
              </tr>
              <tr>
                  ...
                  <td><form action="https://jeb.biologists.org/content/jexbio/214/7/1063.full.pdf" target="blank">
                    <button className="PDF">PDF</button>
                  </form></td>
              </tr>
          </table>
          ...
          <table className = "container">
              <tr>
                  ...
                  <td><form action="https://www.frontiersin.org/articles/10.3389/fspas.2018.00012/full" target="blank">
                    <button className="PDF">Link</button>
                  </form></td>
              </tr>
              <tr>
                  ...
                  <td><form action="https://www.jstor.org/stable/pdf/43632009.pdf?refreqid=excelsior%3Adad43b007f80934cfec399758102bc74" target="blank">
                    <button className="PDF">PDF</button>
                  </form></td>
              </tr>
              <tr>
                  ...
                  <td><form action="https://www.archive.cri-paris.org/wp-content/uploads/Workshop-Summary-article_nightscience-July-2011.pdf" target="blank">
                    <button className="PDF">PDF</button>
                  </form></td>
              </tr>
          </table>
