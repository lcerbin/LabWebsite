...
const Publications = () => {
    return (
      <div>
           ...
           <h1 className = "Head">Biomechanics</h1>
               <div className = "table">
          ...
          <h3 className = "title">Biomechanics</h3>
          <table className = "container">
            ...
            <p>
            (<a href="https://europepmc.org/backend/ptpmcrender.fcgi?accid=PMC6657585&blobtype=pdf" target="blank">PDF</a>)
            </p>
